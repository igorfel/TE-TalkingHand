...
//    this->properties.centralWidget->hide();

//    this->properties.setPlotSize(this->properties.windowSizeX/**(xSubplot-1)*/,this->properties.windowSizeY/**(ySubplot-1)*/,this->properties.windowSizeX, this->properties.windowSizeY);
//    customPlot->setGeometry(this->properties.centralWidget->rect());//QRect(0, 0, this->properties.centralWidget->geometry().width(), this->properties.centralWidget->geometry().height()));
...
//    this->properties.centralWidget->show();
//}
...
//        this->setLegend();
    ...
    customPlot->rescaleAxes();
    if(this->properties.xAxisRangeFlag)
        customPlot->xAxis->setRange(this->properties.getxAxisMinRange(), this->properties.getxAxisMaxRange());
    if(this->properties.yAxisRangeFlag)
        customPlot->yAxis->setRange(this->properties.getyAxisMinRange(), this->properties.getyAxisMaxRange());
    //customPlot->replot();
